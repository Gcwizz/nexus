  ...
  return (
    <main class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      ...
      <div class="flex flex-col items-center text-center max-w-md">
        <span class="text-xs font-mono text-gray-400 mb-2">Module 2</span>
        <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-2">
          Ontology Engine
        </h1>
        <p class="text-gray-500 mb-8">
          Automatically map your organisation's structure, processes, and relationships into a formal ontology.
        </p>

        <div class="border-2 border-dashed border-gray-300 rounded-xl p-12 w-full flex flex-col items-center gap-4">
          <span class="text-gray-400 text-sm">No ontology generated yet</span>
        </div>
      </div>
    </main>
  );
